...
namespace LA
{
	...
	void Convert8to10(char* s); // конвертируем из весмеричной в десятичную систему счисления
	void Convert2to10(char* s); // конвертируем из двоичной в десятичную систему счисления
}